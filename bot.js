...
client.on('message', message => {
    if(message.content.includes('discord.gg')){
        ...
        message.delete()
    return message.reply(`** ابعت كمان مره و بان  !**`)
    }
}
});
...
client.login('NTQyNzMxOTE4NTMwMTgzMTg4.Dz5QOA.l9A5WgX4chySbUyBEy12dyCmhRk');
